...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        graphWidget->setGeometry(QRect(30, 110, 551, 401));
        controlPanel = new QWidget(centralwidget);
        controlPanel->setObjectName(QString::fromUtf8("controlPanel"));
        controlPanel->setGeometry(QRect(610, 110, 161, 401));
        verticalLayoutWidget = new QWidget(controlPanel);
        verticalLayoutWidget->setObjectName(QString::fromUtf8("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(0, 0, 161, 401));
